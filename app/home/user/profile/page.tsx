...
import ProfileComp from '@/app/components/ProfileComponent';
    ...
    return (
        <div>
            ...
            <div className='mt-20'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-5 mt-10 mb-[200px] gap-6">
                    {data.map((song) => (
