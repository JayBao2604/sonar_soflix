...
export default function Footer() {
  ...
  <div className="mx-auto max-w-5xl justify-center text-center flex flex-col items-center px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-white">
      Mang đến cho bạn trải nghiệm nghe nhạc tuyệt vời nhất bằng cách kết hợp với music video 
      tăng tính tương tác và giúp bạn hiểu rõ hơn về bài hát mình yêu thích.
    </p>
